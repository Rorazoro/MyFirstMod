package com.github.rorazoro.myfirstmod.entities;
...
public class EmeraldSheepEntity extends AnimalEntity {

    private EatGrassGoal eatGrassGoal;
    private int exampleTimer;

    public EmeraldSheepEntity(EntityType<? extends AnimalEntity> type, World worldIn) {
        super(type, worldIn);
    }

    @Override
    public AgeableEntity createChild(AgeableEntity ageable) {
        EmeraldSheepEntity entity = new EmeraldSheepEntity(EntityTypeInit.EMERALD_SHEEP.get(), this.world);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3,
                new TemptGoal(this, 1.1D, Ingredient.fromItems(ItemInit.EASTEREGG_ITEM.get()), false));
