package com.github.rorazoro.myfirstmod.util.helpers;
...
public class NBTHelper {
	...
	public static CompoundNBT toNBT(Object o) {
		...
		if(o instanceof ModTestTileEntity) {
			return writeModTest((ModTestTileEntity)o);
		}
		
		return null;
	}
	
	private static CompoundNBT writeModTest(ModTestTileEntity o) {
