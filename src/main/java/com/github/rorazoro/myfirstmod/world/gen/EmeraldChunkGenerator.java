...
public class EmeraldChunkGenerator extends NoiseChunkGenerator<EmeraldGenerationSettings> {

   public EmeraldChunkGenerator(IWorld worldIn, BiomeProvider biomeProviderIn, EmeraldGenerationSettings settingsIn) {
